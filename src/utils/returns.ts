...
export const priceOverrides = [
  '0x7ad7F515E61107343B69F9FF2EDEBC3f50e187ab', // USDC
...
function formatPricesForEarlyTimestamps(position): Position {
  if (position.timestamp < PRICE_DISCOVERY_START_TIMESTAMP) {
    ...
    // WETH price
    if (position.pair?.token0.id === '0x0277962b0177b6F210b55b03781Bb7cf976b3e27') {
      position.token0PriceUSD = 203
    }
    if (position.pair?.token1.id === '0x0277962b0177b6F210b55b03781Bb7cf976b3e27') {
